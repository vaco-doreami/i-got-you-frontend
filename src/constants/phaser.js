...
export const SEND_MOVE_PLAYER = "send-move-player";
export const SEND_STOP_PLAYER = "send-stop-player";

export const POLICE_OPACITY_CHANGED = "police-opacity-changed";
